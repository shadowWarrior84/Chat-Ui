...
const updateGroupChatModel = ({fetchAgain, setFetchAgain}) => {
  ...
  return (
    <>
    <IconButton display={{base: "flex"}} icon={<ViewIcon/>} mt={4} onClick={onOpen}/>
    <Modal isOpen={isOpen} onClose={onClose}>
        ...
        <ModalHeader textAlign={"center"}>{selectedChat.chatName}</ModalHeader>
          ...
          <ModalBody>
            ...
            <FormControl display={"flex"}>
                <Input placeholder='Add a User to group' mb={3} value={groupChatName} onChange={(e) => handleSearch(e.target.value)}/>   
            </FormControl>
